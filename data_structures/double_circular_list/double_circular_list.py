...
class CircularDoublyLinkedListGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Circular Doubly Linked List GUI")
        self.layout = QVBoxLayout()

        self.function = QLabel('In a circular doubly linked list, you can insert and delete elements at the beginning and end,\n'
    ...
    def insert_at_beginning(self):
        ...
        if item:
            self.circular_doubly_linked_list.insert_at_beginning(item)
            self.display_list()
    ...
    def insert_at_end(self):
        item = self.input_field.text()
        if item:
            self.circular_doubly_linked_list.insert_at_end(item)
            self.display_list()
        self.input_field.clear()
    ...
    def search_item(self):
        item = self.input_field.text()
        if item:
            if self.circular_doubly_linked_list.search(item):
    ...
    def rotate_left(self):
        self.circular_doubly_linked_list.rotate_left()
        self.display_list()

    def rotate_right(self):
        self.circular_doubly_linked_list.rotate_right()
        self.display_list()

    def display_list(self):
        display_text = self.circular_doubly_linked_list.display()
